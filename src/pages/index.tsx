...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Employee Scheduling v1`}</title>

        <meta
          name="description"
          content="Employee Scheduling v1 - Revolutionizing workforce management by scheduling employees across 100 locations for various services. Efficiency and productivity at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1514782831304-632d84503f6f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzY2hlZHVsaW5nfGVufDB8fHx8MTY5NjA5MjA4M3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Employee Scheduling v1`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Employee Scheduling v1 - Revolutionizing workforce management by scheduling employees across 100 locations for various services. Efficiency and productivity at your fingertips.`}
            </Text>
            <Box

...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'manager', 'hr-administrator', 'employee', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Employees', path: '/employees', entity: 'employee', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
    {
    ...
    {
      name: 'Service Durations',
      path: '/service-durations',

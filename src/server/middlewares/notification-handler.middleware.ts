...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create.create': {
    roles: ['business-owner', 'manager', 'hr-administrator', 'employee'],
    key: 'order',
    tenantPath: [],
    userPath: [],
  },
  ...
  'inventory.update.update': {
    roles: ['business-owner', 'manager', 'hr-administrator'],
    key: 'inventory',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'manager', 'hr-administrator', 'employee', 'customer'];
